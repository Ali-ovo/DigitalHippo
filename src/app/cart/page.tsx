            ...
            {isMounted && items.length === 0 ? (
              <div className='flex h-full flex-col items-center justify-center space-y-1'>
                <div aria-hidden className='relative mb-4 h-40 w-40 text-muted-foreground'>
                  <Image src='/hippo-empty-cart.png' alt='empty shopping cart hippo' loading='eager' fill />
                </div>

                <h3 className='font-semibold text-2xl'> Your cart is empty</h3>
                <p className='text-muted-foreground text-center'>Whoops! Nothing wo show here yet.</p>
              </div>
            ) : null}

          ...
          <div className='lg:col-start-2'>
            ...
            <div className='mt-16 text-sm font-medium'>
              ...
              <div className='space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground'>
                ...
                <div className='flex items-center justify-between order-t border-gray-200 pt-6 text-gra-900'>
              ...
              <PaymentStatus
                ...
                orderEmail={typeof order.user !== 'string' ? order.user.email : ''}
                orderId={order.id}
              />
